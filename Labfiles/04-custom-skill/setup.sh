...
# Now, create the new one
az search service create --name enrichedcognitivesearch$RANDOM --location westus --resource-group $resourceGroupName --sku Free --partition-count 1 --replica-count 1
