...
az storage container create --account-name $storageAccName --name 1040examples --auth-mode loginaz storage container create --account-name $storageAccName --name 1099examples --auth-mode loginaz storage container create --account-name $storageAccName --name testdoc --auth-mode login
